...
import com.browser.fire.databinding.FragmentBrowseBinding
...
class BrowseFragment(private var urlNew: String) : Fragment() {
    ...
    override fun onResume() {
        ...
        mainRef.binding.lnSearchBar.visibility = View.VISIBLE
        mainRef.binding.browserIcon.visibility = View.VISIBLE
